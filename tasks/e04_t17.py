...
print("Start: Excise 04 Task 17")
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -

graph = Graph(title="Excise 04 Task 17 Graph 01",
...
create_print_render_dot(Graph(title="Excise 04 Task 17 Graph 02",
                              filename="e04_t17_g02",
                              body=read_dot_body("tasks\e04_t17_g02.gv")))

create_print_render_dot(Graph(title="Excise 04 Task 17 Graph 03",
                              filename="e04_t17_g03",
                              body=read_dot_body("tasks\e04_t17_g03.gv")))

create_print_render_dot(Graph(title="Excise 04 Task 17 Graph 04",
                              filename="e04_t17_g04",
                              body=read_dot_body("tasks\e04_t17_g04.gv")))

# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
print("End: Excise 04 Task 17")
